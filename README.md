...
| <picture><source media="(prefers-color-scheme: dark)" srcset=".github/icons/upsert-pr.svg"><img width=50 src=".github/icons/upsert-pr-light.svg"></picture> | **[`upsert-pr` _(commits, force-pushes, and creates or updates a PR)_](./upsert-pr/README.md)** |
